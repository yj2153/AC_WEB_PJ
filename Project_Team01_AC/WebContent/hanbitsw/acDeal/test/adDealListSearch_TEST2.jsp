...
<head>
    ...
    <script type="text/ecmascript" src="<c:url value="/hanbitsw/acDeal/jqgrid/js/bootstrap-datepicker.js"/>"></script> 
    <script type="text/ecmascript" src="<c:url value="/hanbitsw/acDeal/jqgrid/js/bootstrap3-typeahead.js"/>"></script> 
    <link rel="stylesheet" type="text/css" media="screen" href="<c:url value="/hanbitsw/acDeal/jqgrid/css/bootstrap-datepicker.css"/>" />
